...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String sqlStmt= "CREATE TABLE " + TABLE_NOTE + " (" + COLUMN_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + COLUMN_NOTE_CONTENT + " TEXT)";
        db.execSQL(sqlStmt);
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        //It will delete the table and recreate a new one.
    ...
    public long insertNote(String noteContent)
    {
        ...
        long results = db.insert(TABLE_NOTE, null, values);
        db.close();
        return results;
    }
    ...
    public ArrayList<Note> getAllNotes()
    {
        ...
        String sqlStmt = "SELECT " + COLUMN_ID + " , " +  COLUMN_NOTE_CONTENT + " FROM " + TABLE_NOTE;
    ...
    public int updateNote(Note data)
    {
        ...
        //it is an array because the condition it may contain more than 1 id
